...
const projects = [
  {
    ...
    techStack: ['React (Vite)', 'Firebase (Auth, Firestore)'],
    ...
    demo: 'https://julias-recipe-box.vercel.app',
  ...
  },
  {
    ...
    demo: 'https://julias-habit-tracker.vercel.app/',
  ...
  },
  {
    ...
    techStack: ['Claude'],
    retrospective: 'This was my first website working with Claude and Nano Banana. I learned a lot about how to give better prompts to get more polished results. In retrospect, I would have spent more time on the design phase to make it more usable and removed excessive placeholder images.',
    demo: 'https://julias-luxe-locks.vercel.app/',
